...
def LUT5(rom, **kwargs):
    if isinstance(rom, IntegerTypes):
        rom = int2seq(rom, 32)
    I0, I1, I2, I3, I4 = Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit))
...
def LUT6(rom, **kwargs):
    if isinstance(rom, IntegerTypes):
        rom = int2seq(rom, 64)
    I0, I1, I2, I3, I4, I5 = Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit))
...
def LUT7(rom, **kwargs):
    if isinstance(rom, IntegerTypes):
        rom = int2seq(rom, 128)
    I0, I1, I2, I3, I4, I5, I6 = Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit))
...
def LUT8(rom, **kwargs):
    if isinstance(rom, IntegerTypes):
        rom = int2seq(rom, 256)
    I0, I1, I2, I3, I4, I5, I6, I7 = Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit)), Wire(In(Bit))
