...
def test_simple_top():
    ...
    m.compile("build/test_simple_top", Top, output="coreir-verilog", inline=True)
...
def test_two_ops():
    ...
    m.compile("build/test_two_ops", Top, output="coreir-verilog", inline=True)
    ...
    tester.compile_and_run(target="verilator",
                           directory="tests/test_coreir/build",
                           skip_compile=True)
