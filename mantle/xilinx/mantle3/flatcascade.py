...
#
#  And = DefineFlatCascade(n, 4,   A0&A1&A2&A3,  1, 0, 1)
# Nand = DefineFlatCascade(n, 4,   A0&A1&A2&A3,  1, 1, 0)
#   Or = DefineFlatCascade(n, 4, ~(A0|A1|A2|A3), 0, 1, 0)
#  Nor = DefineFlatCascade(n, 4, ~(A0|A1|A2|A3), 0, 0, 1)
#
